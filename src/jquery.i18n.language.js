...
(function($) {
	...
	var language = {
		...
		'convertNumber' : function(num, integer) {
			...
			var transformTable = this.digitTransformTable($.i18n().locale),
				numberString = '' + num,
				convertedNumber = '';
			if (!transformTable) {
				return num;
